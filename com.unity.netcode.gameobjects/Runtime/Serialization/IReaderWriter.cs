...
namespace Unity.Netcode
{
    public interface IReaderWriter
    {
        ...
        void SerializeValue<T>(ref List<T> array) where T : unmanaged;
        ...
        void SerializeNetworkSerializable<T>(ref T[] value) where T : INetworkSerializable, new();
        // Has to have a different name to avoid conflicting with "where T: unmananged"
        void SerializeNetworkSerializable<T>(ref List<T> value) where T : INetworkSerializable, new();
        ...
        void SerializeValuePreChecked<T>(ref List<T> array) where T : unmanaged;
